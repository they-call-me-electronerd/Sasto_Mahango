            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2 col-md-3 col-6">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ...
                        <li style="margin-bottom: 0.75rem;"><a href="<?php echo SITE_URL; ?>/public/about.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: color 0.3s;" onmouseover="this.style.color='#f97316';" onmouseout="this.style.color='#cbd5e1';"><i class="bi bi-chevron-right" style="font-size: 0.75rem;"></i> About Us</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ...
                        <li style="margin-bottom: 0.75rem;"><a href="<?php echo SITE_URL; ?>/public/about.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: color 0.3s;" onmouseover="this.style.color='#f97316';" onmouseout="this.style.color='#cbd5e1';"><i class="bi bi-chevron-right" style="font-size: 0.75rem;"></i> How It Works</a></li>
                        <li style="margin-bottom: 0.75rem;"><a href="<?php echo SITE_URL; ?>/public/about.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: color 0.3s;" onmouseover="this.style.color='#f97316';" onmouseout="this.style.color='#cbd5e1';"><i class="bi bi-chevron-right" style="font-size: 0.75rem;"></i> Join Us</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ...
                        <li style="margin-bottom: 0.75rem;"><a href="<?php echo SITE_URL; ?>/public/cookie-policy.php" style="color: #cbd5e1; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: color 0.3s;" onmouseover="this.style.color='#f97316';" onmouseout="this.style.color='#cbd5e1';"><i class="bi bi-chevron-right" style="font-size: 0.75rem;"></i> Cookie Policy</a></li>
                    </ul>
                </div>
            </div>
